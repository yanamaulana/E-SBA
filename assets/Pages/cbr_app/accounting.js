$(document).ready(function () {
    ...
    var TableData = $("#TableData").DataTable({
        ...
        ajax: {
            url: $('meta[name="base_url"]').attr('content') + "CbrAppAccounting/DT_List_To_Approve",
            dataType: "json",
            type: "POST",
        },
        columns: [{
    ...
    function Fn_Approve_Submission() {
        ...
        $.ajax({
            dataType: "json",
            type: "POST",
            url: $('meta[name="base_url"]').attr('content') + "CbrAppAccounting/approve_submission",
    ...
    function Fn_Reject_Submission(rejectionReason) {
        ...
        $.ajax({
            dataType: "json",
            type: "POST",
            url: $('meta[name="base_url"]').attr('content') + "CbrAppAccounting/reject_submission",
            data: formData,
            beforeSend: function () {
                Swal.fire({
                    title: 'Loading....',
