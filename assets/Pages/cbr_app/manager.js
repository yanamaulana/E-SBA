$(document).ready(function () {
    ...
    var TableData = $("#TableData").DataTable({
        ...
        ajax: {
            url: $('meta[name="base_url"]').attr('content') + "CbrAppManager/DT_List_To_Approve",
            dataType: "json",
            type: "POST",
        },
        columns: [{
    ...
    function Fn_Approve_Submission() {
        ...
        $.ajax({
            dataType: "json",
            type: "POST",
            url: $('meta[name="base_url"]').attr('content') + "CbrAppManager/approve_submission",
    ...
    function Fn_Reject_Submission() {
        ...
        $.ajax({
            dataType: "json",
            type: "POST",
            url: $('meta[name="base_url"]').attr('content') + "CbrAppManager/reject_submission",
            data: $('#form-submission').serialize(),
            beforeSend: function () {
                Swal.fire({
                    title: 'Loading....',
