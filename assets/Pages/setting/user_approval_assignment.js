 ...
 */
    ...
    function Fn_Initialized_DataTable(approval) {
        $("#TableData").DataTable({
            ...
            ajax: {
                url: $('meta[name="base_url"]').attr('content') + "Approval_Assignment/DT_List_Approval_Assignment_user",
                dataType: "json",
                type: "POST",
    ...
    function Init_Submit_Form(DataForm) {
        ...
        $.ajax({
            dataType: "json",
            type: "POST",
            url: $('meta[name="base_url"]').attr('content') + "Approval_Assignment/store_user",
            data: DataForm,
            beforeSend: function () {
    ...
    Fn_Initialized_DataTable($('#Approval').val());
});